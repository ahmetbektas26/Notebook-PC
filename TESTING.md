...
- React/DOM testleri: ana modüller, kullanıcı formları, şifre alanı, PDF,
  sesli not, içe aktarma ve hesaplama akışları
- Node testleri: AES-256-GCM kasa motoru ve tekrarlanan alarm tarihleri
...
4. Okul alanında ders ve AKTS/harf notu ekleyip ortalamayı kontrol et.
